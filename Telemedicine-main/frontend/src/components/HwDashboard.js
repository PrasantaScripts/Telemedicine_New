...
import QrGeneration from "./stepperComponents/QrGeneration";
const HwDashboard = () => {
  ...
  //Generate qr codes according to the array

  // const generateQRCodes = (patientArr) => {
  //   patientArr.forEach((patient) => {
  //     const qrData = JSON.stringify(patient.patientData); // Convert patient data to JSON string
  //     const qrCodeImage = <QRCode value={qrData} />; // Generate QR code image
  //     console.log(qrCodeImage);
  //     // Here you can do something with the qrCodeImage, like displaying it in your UI or saving it to state
  //   });
  // };
